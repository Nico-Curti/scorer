...
void scorer :: print_overall_stats (Os & os)
{
	...
	os << std :: left << std :: setw(40) << "cramer_V" << std :: setw(20) << cramer_V << std :: endl;
	...
	os << std :: left << std :: setw(40) << "MCC_analysis" << std :: setw(20) << MCC_analysis << std :: endl;
	os << std :: left << std :: setw(40) << "kappa_analysis_cicchetti" << std :: setw(20) << kappa_analysis_cicchetti << std :: endl;
	os << std :: left << std :: setw(40) << "kappa_analysis_koch" << std :: setw(20) << kappa_analysis_koch << std :: endl;
	os << std :: left << std :: setw(40) << "kappa_analysis_fleiss" << std :: setw(20) << kappa_analysis_fleiss << std :: endl;
	os << std :: left << std :: setw(40) << "kappa_analysis_altman" << std :: setw(20) << kappa_analysis_altman << std :: endl;
	os << std :: left << std :: setw(40) << "V_analysis" << std :: setw(20) << V_analysis << std :: endl;
	os << std :: left << std :: setw(40) << "TPR_macro" << std :: setw(20) << TPR_macro << std :: endl;
	os << std :: left << std :: setw(40) << "PPV_macro" << std :: setw(20) << PPV_macro << std :: endl;
	os << std :: left << std :: setw(40) << "ACC_macro" << std :: setw(20) << ACC_macro << std :: endl;
	os << std :: left << std :: setw(40) << "F1_macro" << std :: setw(20) << F1_macro << std :: endl;
}
