...
cdef class _scorer:
  ...
  def evaluate (self, int[::1] lbl_true, int[::1] lbl_pred, int n_lbl):
    ...
    score = {
              ...
              'TPR(Sensitivity, recall, hit rate, or true positive rate)' :              [(deref(self.thisptr).TPR.get())[i] for i in range(self.Nclass)],
              ...
              'Gwet AC1' :             deref(self.thisptr).AC1,
              ...
              'Kappa 95% CI' :         deref(self.thisptr).kappa_CI,
              'Standard Error' :       deref(self.thisptr).overall_accuracy_se,
              '95% CI' :               deref(self.thisptr).overall_accuracy_ci,
              ...
              'Overall J' :            deref(self.thisptr).overall_jaccard_index,
