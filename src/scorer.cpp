...
#pragma omp section
#endif
		this->TPR_PPV_F1_micro = get_TPR_PPV_F1_micro (this->TP.get(), this->FN.get(), Nclass);
...
#pragma omp section
#endif
		this->OC = get_OC (this->TP.get(), this->TOP.get(), this->P.get(), Nclass);

#ifdef _OPENMP
#pragma omp section
#endif
		this->OOC = get_OOC (this->TP.get(), this->TOP.get(), this->P.get(), Nclass);
...
#pragma omp section
#endif
		this->GI = get_GI (this->AUC.get(), Nclass);

#ifdef _OPENMP
#pragma omp section
#endif
		this->LS = get_LS (this->PPV.get(), this->PRE.get(), Nclass);
...
#pragma omp section
#endif
		this->overall_accuracy_ci = get_overall_accuracy_ci (this->overall_accuracy, this->overall_accuracy_se);
